  ...
  <a-popover
            ...
            <a-list>
              <a-list-item :key="index" v-for="(record, index) in announcement1">
                <div style="margin-left: 5%;width: 80%">
                  ...
                  <p style="font-size: 13px; color: rgba(0,0,0,.45);margin-bottom: 0px">{{ GetTime(record.sendTime) }} 发布</p>
                </div>
    ...
    <span @click="fetchNotice" class="header-notice">
      <a-badge :count="msgTotal">
        <svg-icon style="font-size: 18px; cursor: pointer" class-name="bell" icon-class="bell" />
      </a-badge>
    </span>
  ...
  export default {
    ...
    data () {
      return {
        loadding: false,
        url:{
          listCementByUser:"/sys/annountCement/getMyAnnouncementSend",
          editCementSend:"/sys/announcementSend/editByAnntIdAndUserId",
    ...
    methods: {
      ...
      showAnnouncement(record){
        postActionByQueryString(this.url.editCementSend,{anntSendId:record.anntSendId}).then((res)=>{
          this.loadData();
        });
        this.hovered = false;
      ...
      websocketOnmessage: function (e) {
        ...
        if(data.cmd == "topic"){
          ...
          this.$notify({
            ...
            onClick: () => {
              this.$refs.noticePopover.$el.click()
            }
          });
