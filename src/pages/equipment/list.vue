<template>
    ...
    <a-layout>
      ...
      <a-layout-sider :width="slider1==550?'550':'0'"   :style="style1"> <!--v-if="slider1==550"-->
        ...
        <el-tag style="float:right" :type="item.contractId==2?'success':'danger'">
         ...
         <a-button style="background:#42b983;color:#fefefe;" @click="toSearch">查询</a-button>
         </div>
        <!--      合同显示布局区域        -->
         <div style="padding:1em;margin-top:1em;height:605px;">
             
             <a-row>
                  <a-descriptions :title="contractinfo[0].title" size="small" bordered>
    ...
    <a-descriptions-item :span="4" label="合同附件状态">
      <a-row>
        <a-col :span="8"><el-tag>供货发票</el-tag></a-col>
        <a-col :span="8"><el-tag>付款通知单</el-tag></a-col>
        <a-col :span="8"><el-tag>实际付款状态</el-tag></a-col>
      </a-row>
    </a-descriptions-item>
    <a-descriptions-item :span="4" label="附件查看">
      2018-04-24 18:00:00
    </a-descriptions-item>
    <a-descriptions-item :span="4" :col="2" label="备注">
     {{contractinfo[0].remark}}
                ...
                <a-row>
                <a-button style="background:#42b983;color:#fefefe;float:right;margin-top:10px;" @click="toSub">填写合同信息</a-button>
             </a-row>
      ...
      >
        ...
        <a-table-column :width="150" key="projectName" data-index="projectName" title="采购项" >
          <template slot-scope="text,scope">
            <el-tag :type="scope.auditStatus===1? 'success':scope.auditStatus=== 2?'danger':'warning'" @click="toadd">{{scope.auditStatus ===1 ?'已填写签收单':'未填写'}}</el-tag>
          </template>
        </a-table-column>
    ...
    <el-dialog :title="title1" :visible.sync="invisible">
      ...
      <el-form ref="form" :model="form" :rules="rule">
        ...
        <div :style="active === 2?{display: 'block'}:{display:'none'}">
          ...
          <a-row>
             <a-col :span="8">
               <el-form-item label="应付款"  label-width="80px" size="small" prop="contractName">
            <el-input v-model="form.needPay" clearable placeholder="应付款" value-key="name" size="small">
            </el-input>
          </el-form-item>
             </a-col>
             <a-col :span="8">
                <el-form-item label="单位" label-width="80px" size="small" prop="contractNo">
            <el-input v-model="form.unitMoney" clearable placeholder="单位" value-key="name" size="small">
            </el-input>
          </el-form-item>
             </a-col>
             <a-col :span="8">
               <el-form-item label="货币" label-width="80px" size="small" prop="price">
            <el-input v-model="form.currecy" clearable placeholder="货币" value-key="name" size="small">
            </el-input>
          </el-form-item>
             </a-col>
          </a-row>
         ...
         <a-row>
           <a-col :span="8">
              <el-form-item label="已付款" label-width="80px" size="small" prop="type">
            <el-input v-model="form.alreadyPayment" clearable placeholder="已付款" value-key="name" size="small">
            </el-input>
          </el-form-item>
           </a-col>
           <a-col :span="8">
          ...
          <a-row>
            <a-col :span="8">
               <el-form-item label="预定付款时间" label-width="80px" size="small" prop="firstParty">
            <el-input v-model="form.schedulerPayTime" clearable placeholder="预定付款时间" value-key="name" size="small">
            </el-input>
          </el-form-item>
            </a-col>
            <a-col :span="8">
               <el-form-item label="预定到货时间" label-width="80px" size="small" prop="secondParty">
            <el-input v-model="form.schedulerDeliveryTime" clearable placeholder="预定到货时间" value-key="name" size="small">
            </el-input>
          </el-form-item>
            </a-col>
            <a-col :span="8">
<el-form-item label="勾选额外信息" label-width="80px" size="small" prop="type">
          <el-row>
          <el-col :span="6"><el-checkbox v-model="form.BondStatus" @change="addInfo">履约保证金</el-checkbox></el-col>
         ...
         <a-row>
           <a-col :span="8">
             <el-form-item label="保证金金额" label-width="80px"  size="small" prop="mainContent" v-if="form.BondStatus===true">
            <el-input v-model="form.performanceBound" clearable placeholder="金额" value-key="name" size="small">
            </el-input>
          </el-form-item>
           </a-col>
           <a-col :span="8">
              <el-form-item label="单位" v-if="form.BondStatus===true" label-width="80px" size="small" prop="contractNo">
            <el-input v-model="form.unitMoney" clearable placeholder="单位" value-key="name" size="small">
            </el-input>
          </el-form-item>
           </a-col>
           <a-col :span="8">
             <el-form-item label="货币" v-if="form.BondStatus===true" label-width="80px" size="small" prop="price">
            <el-input v-model="form.currecy" clearable placeholder="货币" value-key="name" size="small">
            </el-input>
          </el-form-item>
           </a-col>
         ...
         <a-row>
           <a-col :span="8">
           <el-form-item label="保证金支付时间" label-width="80px"  size="small" prop="mainContent" v-if="form.BondStatus===true">
          <el-date-picker
      ...
      placeholder="选择日期时间">
           ...
           <a-col :span="8">
             <el-form-item label="保证金归还时间" label-width="80px"  size="small" prop="mainContent" v-if="form.BondStatus===true">
          <el-date-picker
      ...
      placeholder="选择日期时间">
           ...
           <a-col :span="8">
             <el-form-item label="保证金信息" label-width="80px"  size="small" prop="mainContent" v-if="form.BondStatus===true">
            <el-select v-model="form.performanceBondStatus" type="textarea" :autosize="{ minRows:3, maxRows: 10}">
              <el-option
      ...
      value="2">
          ...
          <a-row>
            <a-col :span="12">
               <el-form-item label="付款方式"  label-width="80px" size="small" prop="projectName">
            <el-select v-model="form.payType" clearable placeholder="付款方式" value-key="name" size="small">
              <el-option
              key="performanceBound"
              label="货到付款"
              value="货到付款">
...
<el-form-item label="供货发票状态" label-width="80px"  size="small" prop="mainContent" v-if="form.BondStatus2===true">
            <el-select v-model="form.supplierlnvoice" type="textarea" :autosize="{ minRows:3, maxRows: 10}">
              <el-option
      key="performanceBound"
      label="未上传"
      value="1">
      ...
      value="2">
          ...
          <el-form-item label="付款通知单" label-width="80px"  size="small" prop="mainContent" v-if="form.BondStatus3===true">
            <el-select v-model="form.paymentNotice" type="textarea" :autosize="{ minRows:3, maxRows: 10}">
              <el-option
      key="performanceBound"
      label="未上传"
      value="1">
      ...
      value="2">
          ...
          <el-form-item label="付款实际状态" label-width="80px"  size="small" prop="mainContent" v-if="form.BondStatus4===true">
            <el-select v-model="form.actualPayment" type="textarea" :autosize="{ minRows:3, maxRows: 10}">
              <el-option
      key="performanceBound"
      label="未上传"
      value="1">
      ...
      value="2">
           ...
           <el-form-item label="备注" label-width="80px"  size="small" prop="mainContent">
  ...
  onSelectAll: (selected, selectedRows, changeRows) => {
    console.log(selected, selectedRows, changeRows);
        ...
        return{
          ...
          title1:'填写合同信息',
          selectedRowKeys: [],
          contractinfo:[{title:'新钢自动化部采购合同',payType:'货到付款',operator:'小辣椒',needPay:'230',alreadyPayment:'230',schedulerPayTime:'2021-1-29 20:59:21',schedulerDeliveryTime:'2021-1-29 20:59:21',performanceBound:'50',performanceBondStatus:'已支付',performanceBoundPayTime:'2021-1-29 20:59:21',performanceBoundDeliverTime:'2021-1-29 20:59:21',remark:'采购200件电脑'}],
          invisible:false,
          form:{},
          BondStatus:false,
          submitLoading: false,
...
this.slider1=550
      ...
      toSearch(){
        ...
        getAction('url',{projectID:this.project.projectId,contractId:'this.project.contractId'})
        .then(resp=>{
      ...
      loadcontract(){
        getAction('url',{projectId:this.project.projectId})
        .then(resp=>{
