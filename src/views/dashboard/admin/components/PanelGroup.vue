    ...
    <el-col :xs="24" :sm="24" :lg="12" class="card-panel-col">
      <div class="card-panel" @click="handleSetLineChartData('projects')">
        ...
        <div class="card-panel-description">
          ...
          <count-to :start-val="0" :end-val="countData.proTotal" :duration="2600" class="card-panel-num" />
        </div>
      </div>
    </el-col>
    <el-col :xs="24" :sm="24" :lg="12" class="card-panel-col">
      <div class="card-panel" @click="handleSetLineChartData('suppliers')">
        ...
        <div class="card-panel-description">
          ...
          <count-to :start-val="0" :end-val="countData.supTotal" :duration="3000" class="card-panel-num" />
        </div>
      </div>
    </el-col>
  </el-row>
...
export default {
  ...
  methods: {
    ...
    loadData() {
      request.get("/sysIndex/findProAndSupplier")
        .then(resp => {
